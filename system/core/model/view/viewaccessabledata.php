...
class ViewAccessableData extends Object implements IteratorAggregate, ArrayAccess
{		
		/**
		 * default castings
		 *@name defaultCasting
		...
		*/
		...
		//!Iterator
		/**
		 * returns a iterator out of this data
		*/
...
class ViewAccessableDataIterator extends ArrayIterator {
	/**
