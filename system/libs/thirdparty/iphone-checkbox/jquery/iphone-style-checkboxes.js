/**
 * @author http://awardwinningfjords.com/2009/06/16/iphone-style-checkboxes.html
 * @package goma framework
 * edited by: daniel gruber
	...
	*/
	...
	iOSCheckbox = (function() {
		...
		*/
		...
		/**
		 * adds the HTML for the iphone-checkbox
		*/
		...
		/**
		 * disables selection on the element, so it's interacting correct
		*/
		...
		*/
		iOSCheckbox.prototype.initialPosition = function() {
			...
			// first reset
			this.offLabel.css("width", "");
			this.handle.css("left", "");
			this.onLabel.css("width", "");
			this.offSpan.css("margin-right", "");
			this.onLabel.css("width", "");
			this.onSpan.css("margin-left", "");
