...
class TemplateInfoTest extends GomaUnitTest {
	...
	*/
	...
	public function testScreenshotAndPlist() {
		$count = count(TemplateInfo::get_available_templates("gomacms", ClassInfo::appVersion(), GOMA_VERSION . "-" . BUILD_VERSION));
		
		$this->author = randomString(10);
		$this->initDir($this->author);
		$ncount = count(TemplateInfo::get_available_templates("gomacms", ClassInfo::appVersion(), GOMA_VERSION . "-" . BUILD_VERSION));
		...
		$n2count = count(TemplateInfo::get_available_templates("gomacms", ClassInfo::appVersion(), GOMA_VERSION . "-" . BUILD_VERSION));
